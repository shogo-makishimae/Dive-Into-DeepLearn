...
![image.png](Dive-Into-DeepLearn\introduction\imges\Gradient\image_g0.png)

## 梯度的计算

![image1.png](Dive-Into-DeepLearn\introduction\imges\Gradient\image_g1.png) # 如果出现空格“ ” 用%20替代

说明：如果路径方向和梯度方向一致，则为点积

不同方向的梯度（通过该方向的单位向量）

![image2.png](Dive-Into-DeepLearn\introduction\imges\Gradient\image_g2.png)
